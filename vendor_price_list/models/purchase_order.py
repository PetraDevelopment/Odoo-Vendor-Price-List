...
class PurchaseOrderLine(models.Model):
    ...
    def write(self, vals):
        ...
        if vals.get("price_unit"):
            print('vals.get date_order', vals.get('date_order'))
    ...
    def update_supplierinfo_price(self):
        ...
        for line in self.filtered(lambda r: not r.display_type and r.order_id.state in ["purchase", "done"]):
            ...
            if supplier_info:
                ...
                print(" new line.price_unit supplier_info.last_purchase_date_with_update_price ",
                      line.price_unit, supplier_info.last_purchase_date_with_update_price)
    ...
    # Method to update supplier info with the seller's price
    ...
    def _update_supplierinfo(self, seller):
        ...
        if new_seller_price != seller.price:
            print(
                'supplierinfo.sudo().last_purchase_date_with_update_price', self.date_order, self.product_id.name)
