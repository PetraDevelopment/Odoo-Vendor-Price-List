...
class Productsupplierinfo(models.Model):
    ...
    product_of_partner_name = fields.Char(
    ...
    @api.depends('product_of_partner_name', 'price', 'last_purchase_date_with_update_price')
    def _compute_product_name(self):
        for record in self:
            record.product_of_partner_name = record.product_tmpl_id.name
            print(' Self product_name', record.product_of_partner_name)
